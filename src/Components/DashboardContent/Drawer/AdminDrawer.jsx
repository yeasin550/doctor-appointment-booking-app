...
const AdminDrawer = () => {
    ...
    const navItems = [
        ...
        { id: 2, name: "Manage Doctors", path: "/dashboard/manage-doctors" },
        { id: 2, name: "Manage Patients", path: "/dashboard/manage-patients" },
        { id: 2, name: "Appointment Overview", path: "/dashboard/appointment-overview" },
        { id: 2, name: "Payment Management", path: "/dashboard/payment-management" },
        // { id: 3, name: "Home", path: "/" },
