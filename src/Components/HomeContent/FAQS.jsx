        ...
        <div className="py-14 px-8 md:w-11/12 mx-auto">
            ...
            <div className="w-full mx-auto gap-10 py-12 flex flex-col-reverse md:flex-row items-center md:items-start mb-10">
                    ...
                    <div className="mx-auto w-full">
                        <div className="divide-y divide-gray-100">
                            ...
                            <details className="group bg-white px-4 p-1 mb-3">
                                ...
                                <div className="pb-4 text-secondary-500">
                                    If you know you will be late, its courteous to call the doctors office and inform them. Depending on their policy and schedule, they may be able to accommodate you or reschedule your appointment.</div>
                            </details>
                ...
                <div className="w-full md:w-1/2">
                    <img src={FAQSIMG} alt="logo" width={500} height={500} />
                </div>
