...
import { FaCalendarAlt, FaRegClock, FaRegHeart, FaAngleRight } from "react-icons/fa";
    ...
    return (
            <div className="max-w-sm rounded-2xl overflow-hidden shadow-md bg-white">
                <div className="relative h-56 bg-gray-200">
                    <img src={post.image} alt="logo" width={500} height={500} className="w-full h-full object-cover" />
                </div>
