...
const Register = () => {
    ...
    return (
        <div className="h-screen">
            <h1 className="text-center font-bold text-3xl mt-2">Create your profile!</h1>
            <form onSubmit={handleSubmit(onSubmit)} className="max-w-md mx-auto border px-6 py-5 shadow-md mt-6 rounded-md">
                <div className="mb-2">
                ...
                <>
                    ...
                    />
                    <h1 className="font-medium">Upload Your Profile Photo</h1>
        ...
        >
          Sign in with Google
                ...
                <p className="mt-3">
                    ...
                    <Link className="text-blue-500 font-bold ml-1" to="/login">
                        Login
                    </Link>
                </p>
