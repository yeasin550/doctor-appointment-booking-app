    ...
    return (
        <div data-aos="zoom-in">
            ...
            >
                ...
                <div>
                    <img src={avatar} className="w-24 mx-auto border-2 border-red-500 rounded-full" alt="" />
                <h2 className="text-3xl font-bold mb-2 text-center border-b-2">Login Here</h2>
                </div>
                <div className="mb-2">
