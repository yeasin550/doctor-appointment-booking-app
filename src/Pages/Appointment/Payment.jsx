...
// /* eslint-disable no-unused-vars */
import visa from "../../assets/payment/visa-card.png";
import paypal from "../../assets/payment/paypal.png";
import mastercard from "../../assets/payment/mastercard.png";
import strip from "../../assets/payment/stripe.png";
    ...
    return (
        <div className="w-11/12 mx-auto px-5 pb-10 bg-white">
            <div className="my-12 space-y-5 w-11/12">
                <h1 className="flex items-center gap-2"><FaDonate className="text-xl"/> Payment NOW</h1>
                <h1 className="text-5xl font-bold">Your Payment</h1>
